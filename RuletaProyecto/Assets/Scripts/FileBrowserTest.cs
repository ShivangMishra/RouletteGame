...
public class FileBrowserTest : MonoBehaviour
{
    ...
    //     FileBrowser.SetFilters(true, new FileBrowser.Filter("videos", ".mp4"), new FileBrowser.Filter("Video Files", ".mp4"));
    ...
    public void ShowFile()
    {
        ...
        {
            fileInput.text = path;
            GameObject.Find("ResolutionManager").GetComponent<ResolutionManager>().filePath = path;
        }
        Debug.Log(path);
    }
}